									...
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/customer_initAddUI.action" target=main>－ 新增客户</A>
													</TD>
												</TR>
												<TR> 
													<TD class=menuSmall>
									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/linkman_initAddUI.action" target=main>－ 新增联系人</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall>
									...
									<TD>
										<TABLE id=table_3 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/customer_findByPage.action" target=main>－ 客户信息查询</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/linkman_findByPage.action" target=main>－ 联系人信息查询</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/visit_findByPage.action" target=main>－ 客户拜访记录查询</A>
													</TD>
												</TR>
											</TBODY>
										</TABLE>
									...
									<TD>
										<TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/total_findIndustry.action" target=main>－客户行业统计</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/total_findSource.action" target=main>－客户来源统计</A>
													</TD>
												</TR>
