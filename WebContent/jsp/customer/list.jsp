...
<SCRIPT language=javascript>
	...
	//初始化页面时加载下拉框的内容
	$(function(){
		url="${pageContext.request.contextPath}/dict_findDictByCode.action";
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<td>
														<select id="sourceId" style="WIDTH: 80px" maxLength=50 name="source.dict_id">
													...
													<td>
														<select id="industryId" style="WIDTH: 80px" maxLength=50 name="industry.dict_id">
															<option value="">--请选择--</option>
														</select>
													</td>
													<td>
													...
													<td>
														<select id="levelId" style="WIDTH: 80px" maxLength=50 name="level.dict_id">
															<option value="">--请选择--</option>
														</select>
													</td>
													<TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/customer_initEdit?cust_id=${customer.cust_id}">修改</a>
													&nbsp;&nbsp;
